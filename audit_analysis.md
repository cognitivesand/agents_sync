...
| P1-26  | **Cyclic dependency `yaml_frontmatter ↔ parser_bounds`** broken only by lazy imports inside function bodies.                                                                                                                            | both files                                             | 5/CQ-09           |
